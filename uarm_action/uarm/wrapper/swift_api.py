...
class SwiftAPI(object):
    ...
    def set_polar(self, stretch=None, rotation=None, height=None, speed=None, relative=False, wait=False, timeout=10,
    ...
    def set_servo_angle(self, servo_id=0, angle=90, wait=False, timeout=10, speed=None, callback=None):
        ...
        :return: 'OK' or 'TIMEOUT' if wait is True else None
        """
        return self._arm.set_servo_angle(servo_id=servo_id, angle=angle, speed=speed, wait=wait, timeout=timeout,
                                         callback=callback)
    ...
    def set_buzzer(self, frequency=None, duration=None, wait=False, timeout=None, callback=None, **kwargs):
        ...
        :return: 'OK' or 'TIMEOUT' if wait is True else None
        """
        return self._arm.set_buzzer(frequency=frequency, duration=duration, wait=wait, timeout=timeout,
    ...
    def grove_init(self, pin=None, grove_type=None, value=None, wait=True, timeout=None, callback=None):
        ...
        :return: 'OK' or 'TIMEOUT' if wait is True else None
        """
        return self._arm.grove_init(pin=pin, grove_type=grove_type, value=value, wait=wait, timeout=timeout,
                                    callback=callback)
    ...
    def set_3d_feeding(self, distance=0, speed=None, relative=True, x=None, y=None, z=None, wait=True, timeout=30,
                       callback=None):
        """
