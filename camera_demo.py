...
def main():
    ...
    for i in range(num):
        ...
        frame_list.append(numpy_image.copy())
    ...
    end_time = time.time()
    print('collection frame rate : ', float(num/(end_time-start_time)))
    ...
    # out = cv2.VideoWriter('output.mp4', fourcc, 120.0, (1600, 1000))
    # video_save_start_time = time.time()
    # for frame in frame_list:
    #     out.write(frame)
    # video_save_stop_time = time.time()
    # out.release()
    # print('save frame rate : ', float(num/(video_save_stop_time-video_save_start_time)))
